...
//		System.out.println("La entidad es: " + entidad.getNombre() + " "+ entidad.getUsuarioCreacion());
		 ...
		 * Agregar una entidad
		 ******************/
		web = client.resource("http://localhost:8182/SubisTravelWeb/services/entidades");
...
//		nuevaEntidad.setUsuarioActualizacion("rgonzalez@mail.com");
		 ...
		 ********************/
		web = client
				.resource("http://localhost:8182/SubisTravelWeb/services/entidades/1");
...
//		entidadModificada.setUsuarioActualizacion("jperez@mail.com");
		 ...
		 *******************/
		WebResource wr = client.resource("http://localhost:8182/SubisTravelWeb/services/entidades/32");
